...
export const blogData = {
  1: {
    header: {
      headImage: `${getOriginURL}/dalala/images/p7.jpg`,
    ...
    abouts: [
      {
        ...
        timeDelay: "delay-06",
        img: `${getOriginURL}/dalala/images/p-1.jpg`,
  ...
  2: {
    header: {
      headImage: `${getOriginURL}/dalala/images/p8.jpg`,
      title: "Ẩm Thực",
      titleDesc:
    ...
    abouts: [
      {
        ...
        timeDelay: "delay-06",
        img: `${getOriginURL}/dalala/images/11-1.jpg`,
      ...
      },
      {
        ...
        timeDelay: "delay-08",
        img: `${getOriginURL}/dalala/images/12-2.jpg`,
        path: `${PATH_DASHBOARD.FoodAndDrink}`,
        link: "2",
      },
      {
        ...
        timeDelay: "delay-1",
        img: `${getOriginURL}/dalala/images/14.jpg`,
        path: `${PATH_DASHBOARD.FoodAndDrink}`,
        link: "3",
      },
      {
        ...
        timeDelay: "delay-12",
        img: `${getOriginURL}/dalala/images/15.jpg`,
        path: `${PATH_DASHBOARD.FoodAndDrink}`,
        link: "4",
      },
      {
        ...
        timeDelay: "delay-14",
        img: `${getOriginURL}/dalala/images/17.jpg`,
        path: `${PATH_DASHBOARD.FoodAndDrink}`,
        link: "5",
      },
      {
        ...
        timeDelay: "delay-16",
        img: `${getOriginURL}/dalala/images/16.jpg`,
        path: `${PATH_DASHBOARD.FoodAndDrink}`,
        link: "6",
      },
    ],
  ...
  3: {
    header: {
      headImage: `${getOriginURL}/dalala/images/p9.jpg`,
      title: "Đặc Sản",
      titleDesc:
